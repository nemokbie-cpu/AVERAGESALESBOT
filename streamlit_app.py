...
# ── FILTER BEFORE ANALYZE ── (exactly what you asked for)
...
min_price = st.number_input(
    ...
    step=5,
    min_value=0,
    help="Set this BEFORE you click Analyze. Example: 90 = only sales £91 and higher"
)
...
if analyze_clicked:
    if not data.strip():
        ...
        # Price filter (strictly ABOVE the number you set)
        ...
        if len(filtered_sales) < 2:
            ...
            if n < 2:
                ...
                st.markdown(f"""
**📊 120-Day Analysis (Only sales ABOVE £{min_price})**
